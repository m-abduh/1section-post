...
const dummies = {
  ...
  QnA: { title: "ASK THE RIGHT QUESTION", question: "What is the one habit that changed everything for you?", answer: "Showing up every single day, even when motivation is low.", footer: "1section.com" },
