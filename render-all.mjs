...
const dummies = {
  ...
  tips: { title: "FOCUS BETTER", subtitle: "Simple ways to focus better", icon: "ti-bulb", cta: "Small tips. Big impact.", follow_call: "Follow for more practical tips", tips: [
  ...
  ], description: "Focus better with these simple techniques", footer: "1section.com" },
  formula: { title: "The only formula that matters", icon: "ti-math", cta: "Get the formula right. Results follow.", follow_call: "Follow for more success formulas", term1: "Focus", op1: "\u00d7", term2: "Consistency", result: "Results", caption: "The only equation that matters for growth", description: "Get these two right, and everything else follows", footer: "1section.com" },
  tierlist: { title: "Not all methods are worth your time", icon: "ti-layers-difference", cta: "Focus on what actually works.", follow_call: "Follow for more honest rankings", tiers: [
  ...
  checklist: { title: "Four small wins. Big results.", icon: "ti-checklist", cta: "Check it off. Move forward.", follow_call: "Follow for more actionable checklists", items: ["Write down your top three priorities", "Block one hour for deep work", "Review what worked and what didn't", "Plan tomorrow before you log off"], description: "Small daily actions compound into massive results", footer: "1section.com" },
  warning: { title: "You're heading for burnout", icon: "ti-alert-octagon", cta: "Don't ignore the signs. Rest is productive.", follow_call: "Follow for more wellness insights", warning: "Working 10+ hours daily without breaks doesn\u2019t make you productive. It makes you exhausted.", description: "Rest is a strategy, not a reward", footer: "1section.com" }
};
