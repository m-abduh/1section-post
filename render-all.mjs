...
const dummies = {
  ...
  formula: { title: "The Growth Formula", icon: "ti-math", follow_call: "Master the formula for personal growth. Follow for more insights that compound", term1: "Focus", op1: "\u00d7", term2: "Consistency", result: "Growth", caption: "The only equation that matters for self-improvement", description: "Get these two right, and everything else follows", footer: "1section.com" },
